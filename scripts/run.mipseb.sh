...
KERNEL=`get_kernel "mipseb" false`; add_cpenv KERNEL
QEMU_MACHINE=`get_qemu_machine "mipseb"`; add_cpenv QEMU_MACHINE
QEMU_ROOTFS=`get_qemu_disk "mipseb"`; add_cpenv QEMU_ROOTFS
